...
export default function WebsiteMode({ onSwitchToDesktop }: WebsiteModeProps) {
  ...
  return (
    <div className="min-h-screen text-dark-text relative z-10 selection:bg-amber-button/30">
      ...
      <section
        id="hero"
        className="animate-reveal max-w-[900px] mx-auto px-4 sm:px-6 py-10 md:py-16"
      >
        <div
          style={{
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-3 text-xs sm:text-sm text-dark-text-muted select-none">
            ...
            <button type="button" className="flex items-center gap-1 hover:text-amber-button transition-colors bg-transparent border-none p-0 cursor-pointer font-inherit text-inherit" onClick={onSwitchToDesktop}>
      ...
      >
        <div className="bg-dark-surface/90 rounded-2xl p-4 sm:p-8 border border-dark-border/50 shadow-xl overflow-hidden">
          ...
          {/* Animate tab content change with crossfade */}
            <div
              key={activeTab}
              className={`animate-tab-enter border-2 rounded-b-xl p-5 sm:p-8 ${
      ...
      {/* ── COOKIE CONSENT / PRIVACY BANNER ── */}
        {showConsent && (
          <div className="animate-cookie-enter fixed bottom-6 left-6 right-6 sm:left-auto sm:right-6 sm:max-w-sm bg-dark-surface border border-dark-border rounded-xl shadow-2xl p-4 z-[70] flex flex-col gap-3 backdrop-blur-md">
